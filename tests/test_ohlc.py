...
class TestOHLC(unittest.TestCase, TestUtilMixin):
  ...
  def test_BuildOHLC(self):
    ...
    print bar15h
    self.assertEqual(bar15h.open, Decimal('0'))
    self.assertEqual(bar15h.high, Decimal('1600'))
    self.assertEqual(bar15h.low,  Decimal('1000'))
    self.assertEqual(bar15h.close,Decimal('1600'))

    bar16h = get_bar(datetime(2013,1,1,16))
    self.assertEqual(bar16h.open, Decimal('1600'))
    self.assertEqual(bar16h.high, Decimal('2000'))
    self.assertEqual(bar16h.low,  Decimal('1000'))
    self.assertEqual(bar16h.close,Decimal('1600'))
    

    bar17h = get_bar(datetime(2013,1,1,17))
    self.assertEqual(bar17h.open, Decimal('1600'))
    self.assertEqual(bar17h.high, Decimal('1600'))
    self.assertEqual(bar17h.low,  Decimal('1250'))
    self.assertEqual(bar17h.close,Decimal('1600'))
    
    bar18h = get_bar(datetime(2013,1,1,18))
    self.assertEqual(bar18h.open, Decimal('1600'))
    self.assertEqual(bar18h.high, Decimal('1700'))
    self.assertEqual(bar18h.low,  Decimal('1690'))
    self.assertEqual(bar18h.close,Decimal('1690'))
    
    bar19h = get_bar(datetime(2013,1,1,19))
    self.assertEqual(bar19h.open, Decimal('1690'))
    self.assertEqual(bar19h.high, Decimal('1690'))
    self.assertEqual(bar19h.low,  Decimal('1690'))
    self.assertEqual(bar19h.close,Decimal('1690'))
          
    bar20h = get_bar(datetime(2013,1,1,20))
    self.assertEqual(bar20h.open, Decimal('1690'))
    self.assertEqual(bar20h.high, Decimal('1690'))
    self.assertEqual(bar20h.low,  Decimal('1690'))
    self.assertEqual(bar20h.close,Decimal('1690'))
